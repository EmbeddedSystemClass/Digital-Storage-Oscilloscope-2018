...
#define RAM_READ(STATE) SET(PORTD,_BV(PD7),STATE)
#define RAM_READ_DDR(DIR) SET(DDRD,_BV(PD7),DIR)
#define RAM_READ_IN GET(PIND,_BV(PD7))

#define FORCE(STATE) SET(PORTC,_BV(PC0),STATE)
#define FORCE_DDR(DIR) SET(DDRC,_BV(PC0),DIR)
#define FORCE_IN GET(PINC,_BV(PC0))

#define TRIGGER_BTN(STATE) SET(PORTB,_BV(PB2),STATE)
#define TRIGGER_BTN_DDR(DIR) SET(DDRB,_BV(PB2),DIR)
#define TRIGGER_BTN_IN GET(PINB,_BV(PB2))

#define ENABLE(STATE) SET(PORTC,_BV(PC1),STATE)
#define ENABLE_DDR(DIR) SET(DDRC,_BV(PC1),DIR)
#define ENABLE_IN GET(PINC,_BV(PC1))

#define EDGE_SWITCH(STATE) SET(PORTD,_BV(PD6),STATE)
#define EDGE_SWITCH_DDR(DIR) SET(DDRD,_BV(PD6),DIR)
#define EDGE_SWITCH_IN GET(PIND,_BV(PD6))

#define LED1(STATE) SET(PORTB,_BV(PB0),~STATE) // Optional LED GPIO
#define LED1_DDR(DIR) SET(DDRB,_BV(PB0),DIR)
#define LED1_IN GET(PINB,_BV(PB0))

#define LED2(STATE) SET(PORTB,_BV(PB0),~STATE) // Optional LED GPIO
#define LED2_DDR(DIR) SET(DDRB,_BV(PB0),DIR)
#define LED2_IN GET(PINB,_BV(PB0))	

#define LED3(STATE) SET(PORTB,_BV(PB0),~STATE) // Optional LED GPIO
#define LED3_DDR(DIR) SET(DDRB,_BV(PB0),DIR)
#define LED3_IN GET(PINB,_BV(PB0))	
...
#define SCS(STATE) SET(PORTB,_BV(PB4),STATE)
#define SCS_DDR(DIR) SET(DDRB,_BV(PB4),DIR)
#define SCS_IN GET(PINB,_BV(PB4))	

#define SCK(STATE) SET(PORTB,_BV(PB7),STATE)
#define SCK_DDR(DIR) SET(DDRB,_BV(PB7),DIR)
#define SCK_IN GET(PINB,_BV(PB7))	

#define PLL_S0(STATE) SET(PORTD,_BV(PD3),STATE) // PLL control line setup S0
#define PLL_S0_DDR(DIR) SET(DDRD,_BV(PD3),DIR)
#define PLL_S0_IN GET(PIND,_BV(PD3))	

#define PLL_S1(STATE) SET(PORTD,_BV(PD4),STATE) // PLL control line setup S1
#define PLL_S1_DDR(DIR) SET(DDRD,_BV(PD4),DIR)
#define PLL_S1_IN GET(PIND,_BV(PD4))
...
#define SLOW_CLK(STATE) SET(PORTC,_BV(PC6),STATE) // Databuffer read clocking signal
#define SLOW_CLK_DDR(DIR) SET(DDRC,_BV(PC6),DIR)
#define SLOW_CLK_IN GET(PINC,_BV(PC6))	

#define FILL_COMP(STATE) SET(PORTC,_BV(PC7),STATE)
#define FILL_COMP_DDR(DIR) SET(DDRC,_BV(PC7),DIR)
#define FILL_COMP_IN GET(PINC,_BV(PC7))	
